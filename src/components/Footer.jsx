  ...
  return (
    <footer className="relative w-full">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16">
        <div className="rounded-3xl p-8 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]">
          ...
          <div className="flex flex-col gap-12 lg:flex-row lg:gap-16">
            ...
            <div className="flex-1 space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xl font-bold text-gray-300">NDU/TCC</span>
              </div>
