...
const timelineData = [
    ...
    {
      title: "March 2025: Quantum Computing with NVIDIA Researchers",
      content: (
        <div>
          <p
            className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
  ...
  {
    title: "April 2025: Tech & Leadership at Amazon",
    content: (
      <div>
        <p
  ...
  {
    title: "June 2025: Hacking Lebanon",
    content: (
      <div>
        <p
          className="mb-4 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
